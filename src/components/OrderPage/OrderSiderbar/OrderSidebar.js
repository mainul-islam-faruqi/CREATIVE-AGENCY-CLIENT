...
import orderListIcon from '../../../images/icons/serviceList.png';
    ...
    return (
        <section className="sidebar">
            ...
            <div className="sidebar-option" >
                ...
                <NavLink to="orderList"  activeClassName="active" className="sidebar-link"> <h6> <img src={orderListIcon} alt=""/>  Order list </h6> </NavLink>
